...
export default function BridalMakeup() {
  ...
  const packages = [
    {
      title: "Signature Classic Bridal",
      price: "₹15,000",
      description: "A gorgeous, traditional makeup look designed to look stunning in person and photograph beautifully.",
      features: [
        "Premium brand makeup (MAC, Kryolan)",
        "Traditional / Matte eye styling",
        "Eyelashes & standard hair styling",
        "Dupatta draping & jewelry setting",
        "Change assistance during preparation"
      ]
    },
    {
      title: "Ultra HD Premium Bridal",
      price: "₹18,000",
      description: "High-definition light base, perfect for modern high-resolution cameras. Gives a flawless glow.",
      features: [
        "HD products (Huda Beauty, Sephora, MAC)",
        "Waterproof and transfer-proof finish",
        "Advanced hair design / Textured updos",
        "Dupatta draping & jewelry setting",
        "Nail extensions overlay package included"
      ]
    },
    {
      title: "Luxury Airbrush Bridal",
      price: "₹22,000",
      description: "Specialized spray application technique that creates an ultra-smooth, lightweight base that lasts 24+ hours.",
      features: [
        "Airbrush gun applied silicone-based makeup",
        "Perfect for hot weather (sweat-resistant)",
        "Premium eyelashes & designer hairstyling",
        "Dupatta draping & luxury jewelry setting",
        "Complimentary bridal trial session included"
      ]
    }
  ];
            ...
            {packages.map((pkg, idx) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-2xl font-serif font-bold text-primary mb-4">{pkg.price}</div>
