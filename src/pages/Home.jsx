...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section className="py-28 bg-[#111111]/60 border-t border-b border-white/5 relative">
      ...
      <section className="py-28 bg-[#111111]/60 border-t border-white/5" id="booking-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
