  ...
  return (
    <footer className="bg-dark text-white pt-16 pb-8 border-t border-primary/25 relative overflow-hidden">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex space-x-4 pt-2">
            <a
              ...
              className="w-10 h-10 rounded-full bg-secondary hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-white"
        ...
        <div>
          ...
          <ul className="space-y-4 font-sans text-sm text-muted">
            <li className="flex items-start space-x-3">
              ...
              <span>
                1st Floor, Royal Arcade, Opposite Golden Plaza, Yogi Chowk, Surat, Gujarat 395010
              </span>
            </li>
            <li className="flex items-center space-x-3">
              <FaPhoneAlt className="w-4 h-4 text-primary shrink-0" />
              <a href="tel:+919328412418" className="hover:text-primary transition-colors">
                +91 9328412418
              </a>
            </li>
            <li className="flex items-center space-x-3">
              <FaEnvelope className="w-4 h-4 text-primary shrink-0" />
              <a href="mailto:info@radhebeautycare.com" className="hover:text-primary transition-colors">
                info@radhebeautycare.com
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-white/5 text-center font-sans text-xs text-muted flex flex-col sm:flex-row justify-between items-center gap-4 relative z-10">
        <div>
          &copy; {currentYear} Radhe Beauty Care. All Rights Reserved.
        </div>
