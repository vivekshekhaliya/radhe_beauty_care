...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-dark pt-28 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        >
          ...
          >
            <div>
              <span className="block text-2xl sm:text-3xl font-serif font-bold text-primary">8+</span>
              <span className="text-[10px] text-muted uppercase tracking-widest font-sans font-semibold mt-1 block">Years Experience</span>
            </div>
            <div>
              <span className="block text-2xl sm:text-3xl font-serif font-bold text-primary">1K+</span>
              <span className="text-[10px] text-muted uppercase tracking-widest font-sans font-semibold mt-1 block">Happy Brides</span>
            </div>
            <div>
              <span className="block text-2xl sm:text-3xl font-serif font-bold text-primary">500+</span>
              <span className="text-[10px] text-muted uppercase tracking-widest font-sans font-semibold mt-1 block">Certified Alumni</span>
            </div>
          </motion.div>
        </motion.div>
