...
import kajal1Img from "../assets/IMG_8619.jpg";

export default function AboutSection() {
  const stats = [
    { value: "16+", label: "Years Experience" },
    { value: "10K+", label: "Happy Clients" },
    { value: "100+", label: "National and international award" },
    { value: "1000+", label: "Academy Students" },
  ];

  return (
    <section id="about" className="py-24 bg-dark text-white border-t border-white/5 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">

          {/* Visual Grid of Images */}
          <div className="lg:col-span-5 relative grid grid-cols-2 gap-4">
            {/* Main Image - Portrait (Spans 2 rows to match the height of the 2 square cards on the right) */}
            <div className="row-span-2 rounded-[28px] overflow-hidden shadow-lg border border-white/10 h-full">
              <img
                src={kajalImg}
                alt="Kajal Shekhaliya Lead Artist"
            ...
            <div className="aspect-square rounded-[24px] overflow-hidden shadow-lg border border-white/10">
              <img
                ...
                className="w-full h-[300px] object-cover hover:scale-105 duration-500"
                loading="lazy"
              />
            </div>
